...
- message_task_kandev: Message another task's agent, or a specific session via the optional session_id param — including a sibling session on your OWN task (e.g. one you spawned). Required params: task_id, prompt.
